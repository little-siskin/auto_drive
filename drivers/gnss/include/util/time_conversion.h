...
// Converts GPS timestamp from/to UNIX system timestamp.---将GPS时间戳从/转换为UNIX系统时间戳。
// This helper is considering leap second.---考虑闰妙
...
// We build a lookup table to describe relationship that between UTC and Leap_seconds.
//
...
//          return 28800.
//
//          The diff between 1970/01/01 and 2017/01/01 is 1483228800. (1483257600-28800)
//
// Column2: Leap seconds diff with GPS basetime(Jan 6,1980).
//          We Know that The leap_seconds have been already added 37 seconds util now(2017).
//          So we can calculate leap_seconds diff between GPS (from Jan 6,1980) and UTC time.
